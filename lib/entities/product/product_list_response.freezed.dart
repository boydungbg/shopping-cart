...
abstract class $ProductListResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<Product> products, int perPage, int maxPage, int count, int page});
}
...
class _$ProductListResponseImpl extends _ProductListResponse {
  ...
  @override
  String toString() {
    return 'ProductListResponse(products: $products, perPage: $perPage, maxPage: $maxPage, count: $count, page: $page)';
  }
...
abstract class _ProductListResponse extends ProductListResponse {
  const factory _ProductListResponse(
      ...
      final int maxPage,
      final int count,
      final int page}) = _$ProductListResponseImpl;
